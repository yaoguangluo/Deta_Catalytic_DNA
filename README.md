...
###### Since the latest document paper "The INITONS Catalytic Reflection Between Humanoid DNA and Nero Cell" finished, the Author change the name of AOPM-VPCS-IDUC initons into AOPM-VECS-IDUQ due to the duplication of the same chars P and C. then starts the NUWA plan, please see at Figure 1, similar with the Human's grammar, could format the initons as three types, one for Single-tons A, O, P, M, V, E, C, S, I, D, U, Q; two for Double-tons AA, AO, AP, AM, ... ...OA, OP, OM... AND Triper-tons AAA, AAO, AAP, AAM... Then we could find out more than 1800 Triper initons word's root. if it's root words appear in 2 dimension or more dimension root links... It could happen and detail out the conbination features of more than one millon really world verbal's, so lets talk about the 'YANGLIAOJING' on a researching way as FIGURE 1-1.          


#### Figure 1-1　见文件地址: https://github.com/yaoguangluo/Deta_Resource/blob/master/CN_DT_pdn_computing1_2_2.pdf
...
#### Figure 2　见文件地址: https://github.com/yaoguangluo/Deta_Resource/blob/master/CN_DT_pdn_computing1_2_2.pdf
